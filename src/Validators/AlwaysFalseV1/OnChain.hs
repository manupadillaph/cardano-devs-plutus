...
module Validators.AlwaysFalseV1.OnChain
  ( 
    codeValidator, 
    typedValidator, 
    hashValidator, 
...
import qualified Validators.AlwaysFalseV1.Typos      as T --, ValidatorData (..) ValidatorDatum (..), ValidatorRedeemer (..)
...
mkValidator _ _ _ = traceIfFalse "ALWAYS FALSE VALIDATOR" False
