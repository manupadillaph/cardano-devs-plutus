...
data ValidatorContracts = 
    ...
    MasterFundAndMergePool T.MasterFundAndMergePoolParams |
...
instance PABEffectsContractBuiltin.HasDefinitions ValidatorContracts where
    ...
    getDefinitions        = [
            ...
            MasterFundAndMergePool T.exampleMasterFundAndMergePoolParams ,
    ...
    getContract (MasterFundAndMergePool mfampParams) =   PABEffectsContractBuiltin.SomeBuiltin $ OffChain.masterFundAndMergePool @() @PABEffectsContractBuiltin.Empty mfampParams
