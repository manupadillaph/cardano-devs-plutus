...
module Validators.StakeSimpleV1.TestWithTraceEmulator where
...
testWithEmulator :: Integer -> P.IO ()
testWithEmulator opcion = TraceEmulator.runEmulatorTraceIO' DataDefault.def emCfg (traceWithEmulator opcion)
