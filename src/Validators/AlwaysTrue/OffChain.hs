...
import  Validators.AlwaysTrue.OnChain     (typedValidator, codeValidator, addressValidator)
...
start StartParams{..} = do
    ...
    case oref of
        Nothing -> do
            ...
            logInfo @P.String $ printf  "--------------------------- Started plazo1 fijo %s for token %s" (P.show a) (P.show v)
            void $ awaitTxConfirmed $ getCardanoTxId ledgerTx
            logInfo @P.String $ printf  "--------------------------- Started plazo2 fijo %s for token %s" (P.show a) (P.show v)
...
findUtxoInValidator ppkh name = do
    ...
    logInfo @P.String $ printf ("--------------------------- pkh: " ++ P.show ppkh)
    logInfo @P.String $ printf ("--------------------------- gpName: " ++ P.show name)
    logInfo @P.String $ printf ("--------------------------- addressValidator: " ++ P.show addressValidator)

    utxos <- utxosAt addressValidator

    logInfo @P.String $ printf ("--------------------------- utxos: " ++ P.show utxos)
