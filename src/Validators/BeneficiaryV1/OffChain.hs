...
module Validators.BeneficiaryV1.OffChain
    (
...
import qualified Validators.BeneficiaryV1.Typos      as T
import qualified Validators.BeneficiaryV1.OnChain    as OnChain (typedValidator, codeValidator, addressValidator)
