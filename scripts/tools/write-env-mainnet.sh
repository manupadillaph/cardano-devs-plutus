...
source "$FALCON_DEVS_SCRIPTS/tools/write-env-list-mainnet.sh"
...
lineNew="[ -f \"$FALCON_DEVS_SCRIPTS/tools/write-env-list-mainnet.sh\" ] && source \"$FALCON_DEVS_SCRIPTS/tools/write-env-list-mainnet.sh\" # falcon-devs-env"
